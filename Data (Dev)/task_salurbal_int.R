...
salurbal_covid19_update = function(){
  ...
  ## 0. Setup -----
  {
    ...
    cpu_UHC = !cpu_RL
    if (cpu_UHC) { 
      setwd("C:/Users/rl627/Desktop/Git/SALURBAL COVID19 Dashbaord (Private)/Data (Dev)") 
    } else { setwd("C:/Users/ranli/Desktop/Git local/SALURBAL COVID-19 Dashboard/Data (Dev)") }
  }
