...
# github_data_url = url("https://github.com/rl627/salurbal_covid19_data/raw/master/Clean/covid19_processed_data_dynamic.rdata")
...
server <- function(input, output) {
  ...
  sub_city_level_cumulative_react = reactive({
    ...
    # input = list()
    # input$level_2 = "L1"
    # input$countries_2="Brazil"
    # input$state_city_2 = "Sao Paulo"
    # input$location_map_outcome="cases"
    if(input$level_2 == "L1") {
  ...
  location_daily_react = reactive({
    ...
    req(input$countries_2)
    req(input$state_city_2)
    # input = list(); input$level_2 = "L1";input$countries_2 = "Chile";input$state_city_2 = "Santiago"
    # input = list();input$level_2 = "country"; input$countries_2 = "Argentina"
    df_tmp = tidy.daily %>% 
      filter(level == input$level_2) %>% 
  ...
  output$plot_rolling = renderHighchart({
    ...
    title_tmp  = ifelse(input$level_2=="country",
                        paste0("Normalized Trends of Cases and Deaths in ",input$countries_2),
                        paste0("Normalized Trends of Cases and Deaths in ",input$state_city_2,", ",input$countries_2))
    df_tmp2 = df_tmp %>%
