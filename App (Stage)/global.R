  ...
  navbarPage(title = "COVID-19 in SALURBAL Countries",
             ...
             tabPanel("About App",
                 ...
                 research examining the connections between the environment and human health."),
                     hr(),
                      h4("Data Access"),
                     p("This data is updated daily at 6:00AM EST. If you are a SALURBAL researcher and would like this data linked by SALURBAL ID, then please submit a manuscript proposal and a data request application."),
                     hr(),
                      h4("Data Sources"),
                     ...
                     h4("Version updates:"),
                      tags$ul(
                        ...
                        tags$li("12/16/2020: Data Update: Testing and Positivity at City and Sub-city levevls added for Argentina, Guatemala and Mexico.")
                      ),
                     hr(),
                      h4("Authors"),
